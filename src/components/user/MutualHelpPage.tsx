    ...
    <div className="max-w-4xl mx-auto p-4 pb-24">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
          <p className="text-2xl font-bold text-green-600">{requests.filter(r => r.type === 'offer').length}</p>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
          <p className="text-2xl font-bold text-purple-600">{requests.filter(r => r.status === 'completed').length}</p>
      ...
      <div className="space-y-4">
        {filteredRequests.length === 0 ? (
          <div className="text-center py-12">
            ...
            <button
              onClick={() => setShowCreateModal(true)}
              className="mt-4 px-4 py-2 bg-green-600 text-white rounded-xl font-medium hover:bg-green-700"
            >
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <HeartHandshake className="h-6 w-6 text-green-600 mx-auto mb-2" />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-green-500"
                />
              </div>

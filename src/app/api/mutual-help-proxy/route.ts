...
const MOCK_HELP_POSTS = [
  {
    ...
    description: 'Je cherche quelqu\'un pour m\'emmener au culte le dimanche depuis le quartier Nord.',
    author: { id: '1', name: 'Marie L.', phone: '+33 6 12 34 56 78' },
    location: 'Paris 18e',
  ...
  },
  {
    ...
    description: 'Je suis professeur de français à la retraite et je propose des cours gratuits pour les personnes qui en ont besoin.',
    author: { id: '2', name: 'Jean P.', phone: '+33 6 98 76 54 32' },
    location: 'Lyon',
  ...
  },
  {
    ...
    author: { id: '4', name: 'Famille Martin', phone: '+33 6 55 44 33 22' },
    location: 'Bordeaux',

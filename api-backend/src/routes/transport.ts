...
router.get('/schedule', async (req: Request, res: Response) => {
  try {
    const date = req.query.date as string || getNextSunday();
  ...
  return [
    {
      ...
      stops: ['Marché Central Gombe', 'Rond-point Forescom', 'Église VHD Lemba'],
      departureTime: '08:30',
      returnTime: '13:00',
      capacity: 15,
    ...
    },
    {
      ...
      stops: ['Clinique Ngaliema', 'Binza UPN', 'Église VHD Lemba'],
      departureTime: '08:45',
      returnTime: '13:00',
      capacity: 12,
      driver: 'Jean Kalala',
